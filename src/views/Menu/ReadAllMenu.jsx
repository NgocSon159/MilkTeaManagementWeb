...
{
    alert(MenuIDrow);
    localStorage.setItem('MenuIDSelected', MenuIDrow)
}
...
function DateFormatter(cell, row) {
    ...
    var options = {
        ...
        hour12: false, 
        timeZone: 'Asia/Jakarta' // GMT +7, UTC
    };
...
class ReadAllMenu extends Component {
    constructor(props) {
        super(props)
        this.state = {
            items: [],
            ...
            <div className="main-content">
                <Grid fluid>
                    <Row>
                        ...
                        <Link to="/Menu/CreateMenu"  >create</Link>
                        </button>
                        
                            <BootstrapTable keyField='MenuID' data={this.state.items} columns={columns} pagination={paginationFactory(options)} filter={filterFactory()} rowEvents={rowEvents} />
                        </Col>
                    </Row>
                </Grid>

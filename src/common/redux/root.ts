import { OrderEpic, PaymentOrderEpic } from './../../milktea-project/redux/epics/orderEpics';
...
import { TableEpic, OrderFromTableEpic, PaymentTableEpic } from '../../milktea-project/redux/epics/tableEpics';
...
export const RootEpic: any = combineEpics(PaymentOrderEpic,TableEpic, LoginEpic, FoodEpic, OrderEpic, OrderFromTableEpic, PaymentTableEpic);
